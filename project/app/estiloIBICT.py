...
#
    ...
    coordenadora_nome_formula = f"='Receita x Despesa'!G48"
    coordenadora_cargo_formula = f"='Receita x Despesa'!G49"
    coordenadora_cpf_formula = f"='Receita x Despesa'!G50"
...
def estilo_conciliacoes_bancaria(tabela,tamanho,tamanho2):
    ...
    worksheet.add_image(images[1], "A1")#ibict
    worksheet.add_image(images[0], "E1")#finatec
    ...
    worksheet.row_dimensions[14].height = 6
    worksheet.row_dimensions[15].height = 29.25
    worksheet.row_dimensions[16].height = 6
    ...
    worksheet.merge_cells('A15:F15')
    worksheet['A15'] = "BB RF Simples - CNPJBB RF SIMPLES"
    worksheet['A15'].font = Font(name="Arial", size=12, color="FFFFFF",bold=True)
    worksheet['A15'].alignment = Alignment(horizontal="center",vertical="center")
    worksheet['A15'].fill = PatternFill(start_color=azul_claro, end_color=azul_claro,fill_type = "solid")
    ...
    worksheet['A19'].fill = PatternFill(start_color=cinza, end_color=cinza,fill_type = "solid")

    worksheet['F19'].fill = PatternFill(start_color=cinza, end_color=cinza,fill_type = "solid")
    ...
    #rubricado
    celulaRubricado = F'C{size}'
    stringLozalicaoRubricado = f'C{size}:F{size}'
    worksheet.merge_cells(stringLozalicaoRubricado)
    worksheet[celulaRubricado].fill = PatternFill(start_color="000000", end_color="FFFFFF",fill_type = "lightUp")
    ...
    for rows in worksheet.iter_rows(min_row=22, max_row=22, min_col=1, max_col=6):  
            for cell in rows:
    ...
    for row in worksheet.iter_rows(min_row=1, max_row=size+tamanho2+12,min_col=6,max_col=6):
        for cell in row:
            cell.border = borda
...
def estilo_rendimento_de_aplicacao(tabela,tamanho):
    ...
    coordenadora_nome_formula = f"='Receita x Despesa'!G45"
    coordenadora_cargo_formula = f"='Receita x Despesa'!G46"
    coordenadora_cpf_formula = f"='Receita x Despesa'!G47"
...
estilo_rendimento_de_aplicacao(tabela2,maior)