...
def acharRecibo(entrada,sem,pedido):
    ...
    #recibo
    try:
        #button = navegador.find_element('xpath','//*[@id="btnReciboPedido"]/span')
        button = WebDriverWait(navegador, 2).until(
        EC.visibility_of_element_located((By.XPATH, '//*[@id="btnReciboPedido"]/span'))
    )
    except:
...
def acharReciboDevagar(entrada,sem,pedido):
    navegador = servico()
