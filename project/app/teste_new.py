...
# # Construir o novo caminho sem usar "/"
# dir_planilhas = os.path.join(pipeline, planilhas)
...
# caminho = pegar_caminho("planilhas_preenchidas.txt")
...
# caminho2 = pegar_caminho("planilhas_preenchidas.txt", "planilhasss")
# print(caminho2)
...
def preenche_planilha(planilha, dicionario):
   ...
   # planilha_preenchida = pegar_caminho('preenchido-' + planilha)
    ...
    #/home/ubuntu/Desktop/05_PipelineFinatec/sites/public/static/planilhas_preenchidas
    ...
    # salvar = f"/home/ubuntu/Desktop/05_PipelineFinatec/sites/public/static/imagem/planilhas/a{filename}"
    # salvar = f"/home/ubuntu/Desktop/05_PipelineFinatec/planilhas_preenchidas/a{filename}"
    ...
    # # Supondo que filename seja o nome do arquivo com a extensão, por exemplo, "arquivo.xlsx"
    # caminho_pasta_planilhas = "../../planilhas/"

    # # Obtém o diretório atual do script
    # diretorio_atual = os.path.dirname(os.path.abspath(__file__))

    # # Combina o diretório atual com o caminho para a pasta "planilhas" e o nome do arquivo
    # salvar = os.path.join(diretorio_atual, caminho_pasta_planilhas, filename)
...
# nome_arquivo = 'ModeloFUNDEP.xlsx'
# diretorio_destino = 'planilhas'  # ou qualquer diretório desejado
# planilha = pegar_caminho(nome_arquivo, diretorio_destino)
# preenche_planilha(planilha, planilha_local_dados)